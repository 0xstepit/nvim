return {
    ...
    config = function()
        ...
        vim.cmd([[highlight Statement ctermbg=0 guifg=]] .. C.persianGreen)
        vim.cmd([[highlight Operator ctermbg=0 guifg=]] .. C.strongCyan)
        vim.cmd([[highlight ColorColumn ctermbg=0 guibg=]] .. C.veryDarkBlue)

        vim.cmd([[highlight Type ctermbg=0 guifg=]] .. C.blue)
        vim.cmd([[highlight Special ctermbg=0 cterm=bold gui=bold guifg=]] .. C.pastelPink)
